...
| 뺀 것                                       | 이유                                                                                                                                                                |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 평소 답변과 서브에이전트에 문체 규칙 주입   | 규칙을 넣으면 답에서 기본값 같은 세부가 빠졌습니다. 같은 길이의 중립 문장을 넣었을 때는 빠지지 않았습니다                                                           |
...
3. **예전에 쓰던 규칙도 그 측정도 근거가 되지 못했습니다.** 규칙의 안내대로 고친 대조 글에서 정보가 사라지거나 문장을 잇는 말이 빠졌습니다. 사람이 쓴 글인지를 파일 수정 연도로 짐작했고, 합격선을 결과를 본 뒤에 적기도 했습니다.
